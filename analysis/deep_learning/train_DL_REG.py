...
class CarPriceRegressor(object):
    ...
    def evaluate(self, X, y):
        ...
        plt.xlabel('Stvarne cijene', fontsize=30)
        plt.ylabel('Predviđene cijene', fontsize=30)
        plt.title('Stvarne vs. predviđene cijene automobila', fontsize=30)
        ...
        plt.xlabel('Predviđene cijene', fontsize=30)
        plt.ylabel('Ostatci', fontsize=30)
        plt.title('Graf ostataka', fontsize=30)
        plt.xticks(fontsize=16)
        plt.yticks(fontsize=16)
        plt.grid(True, alpha=0.3)
        plt.tight_layout()
    ...
    def plot_metrics(self):
        ...
        # Plot loss
        plt.subplot(3, 1, 1)
        plt.plot(self.history['train_loss'], label='Greška treniranja', color='blue', linewidth=2)
        plt.plot(self.history['val_loss'], label='Greška validacije', color='red', linewidth=2)
        plt.title('Greška kroz epohe', fontsize=30)
        plt.xlabel('Epoha', fontsize=30)
        plt.ylabel('Greška (MSE)', fontsize=30)
        plt.xticks(fontsize=16)
        plt.yticks(fontsize=16)
        ...
        # Plot R² score
        plt.subplot(3, 1, 2)
        plt.plot(self.history['train_r2'], label='R² treniranja', color='blue', linewidth=2)
        plt.plot(self.history['val_r2'], label='R² validacije', color='red', linewidth=2)
        plt.title('R² kroz epohe', fontsize=30)
        plt.xlabel('Epoha', fontsize=30)
        ...
        plt.title('Raspored stope učenja', fontsize=30)
        plt.xlabel('Epoha', fontsize=30)
        plt.ylabel('Stopa učenja', fontsize=30)
        plt.xticks(fontsize=16)
        plt.yticks(fontsize=16)
        plt.grid(True, alpha=0.3)
